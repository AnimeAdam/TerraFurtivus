...
Window_Base.prototype.escapeIconItem = function(n, database) {
	switch(database){
	case $dataItems:
		return '\x1bC[9]' + '\x1bI[' + database[n].iconIndex + ']' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + " " + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + database[n].name + '\x1bC[0]';
	break;
	case $dataWeapons:
		return '\x1bC[21]' + '\x1bI[' + database[n].iconIndex + ']' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + " " + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + database[n].name + '\x1bC[0]';
	break;
	case $dataArmors:
		return '\x1bC[11]' + '\x1bI[' + database[n].iconIndex + ']' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + " " + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + database[n].name + '\x1bC[0]';
	break;
	default:
		return '\x1bI[' + database[n].iconIndex + ']' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + '\x1b}' + " " + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + '\x1b{' + database[n].name;
	}
};
