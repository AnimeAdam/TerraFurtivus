 ...
 * 
 * @param Quick SE 5
 * @desc To use in the quick talk plugin command as 5.
 *
 * @default
 * 
 * @param Quick SE 6
 * @desc To use in the quick talk plugin command as 6.
 *
 * @default
 * 
 * @param Quick SE 7
 * @desc To use in the quick talk plugin command as 7.
 *
 * @default
 * 
 * @param Quick SE 8
 * @desc To use in the quick talk plugin command as 8.
 *
 * @default
 * 
 * @param Quick SE 9
 * @desc To use in the quick talk plugin command as 9.
 *
 * @default
 * 
 * @param Quick SE 10
 * @desc To use in the quick talk plugin command as 10.
 *
 * @default
 * 
 * @param Quick SE 11
 * @desc To use in the quick talk plugin command as 11.
 *
 * @default
 * 
 * @param Quick SE 12
 * @desc To use in the quick talk plugin command as 12.
 *
 * @default
 * 
 * @param Quick SE 13
 * @desc To use in the quick talk plugin command as 13.
 *
 * @default
 * 
 * @param Quick SE 14
 * @desc To use in the quick talk plugin command as 14.
 *
 * @default
 * 
 * @param Quick SE 15
 * @desc To use in the quick talk plugin command as 15.
 *
 * @default
 * 
 * @param Quick SE 16
 * @desc To use in the quick talk plugin command as 16.
 *
 * @default
 * 
 * @param Quick SE 17
 * @desc To use in the quick talk plugin command as 17.
 *
 * @default
 * 
 * @param Quick SE 18
 * @desc To use in the quick talk plugin command as 18.
 *
 * @default
 *
 * @help
...
Galv.MSE.quickSE = [];
for (var i = 1; i < 19; i++) { //ADAM SZLAMP EDIT
	var name = "Quick SE " + i
